...
![]({{ site.url }}{{ site.baseurl }}/images/research/voyager.png){: style="width: 350px; float: right; border: 100px; padding:25px"; figcaption}
*A 90kb Starship carrying a candidate virulence factor*
