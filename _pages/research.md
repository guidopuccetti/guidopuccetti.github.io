...
![]({{ site.url }}{{ site.baseurl }}/images/research/voyager.png){: style="width: 350px; float: right; border: 25px; padding:25px" figcaption}
...
![]({{ site.url }}{{ site.baseurl }}/images/research/scoPathways.png){: style="width: 450px; float: right; border: 25px; padding:25px"}
