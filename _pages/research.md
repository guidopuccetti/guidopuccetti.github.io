...
<figcaption>A 90kb *Starship* carrying a candidate virulence factor</figcaption>
...
![]({{ site.url }}{{ site.baseurl }}/images/research/lifestyle.png){: style="width: 350px; float: right; border: 100px; padding:25px"}
<figcaption>Many fungi shift between host-associated and free-living stages</figcaption>
...
![]({{ site.url }}{{ site.baseurl }}/images/research/scoPathways.png){: style="width: 350px; float: right; border: 100px; padding:25px"}
<figcaption>Candidate plant defense degrading pathways encoded in metabolic supergenes</figcaption>
